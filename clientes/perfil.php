            ...
            <div id="accordion">
                ...
                <div class="card">
                    <div class="card-header" id="caixa_utilizador">
                        <h6 class="mb-0">
                            <button class="btn btn-link" data-toggle="collapse" data-target="#t_1" aria-expanded="false" 
                                aria-controls="collapseOne">Alterar Nome Completo
                            </button>
                        </h6>
                    </div>
                    ...
                    <div class="card-header" id="caixa_email">
                        <h6 class="mb-0">
                            <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#t_2" 
                                aria-expanded="false" aria-controls="collapseTwo">Alterar E-mail
                            </button>
                        </h6>
                    </div>
                            ...
                            <form action="?a=perfil&p=2" method="post" class="mt-3">
                                <div class="form-group">
                                    <input type="email"
                                        class="form-control"
                                        name="text_email" 
                                        placeholder="Insira aqui o seu novo endereço de e-mail" 
                                        required>
                                </div>
                                ...
                                <div class="form-group">
                                    <input type="email"
                                        ...
                                        placeholder="Confirme o seu novo endereço de e-mail"
                                        required>
                                </div>
                    ...
                    <div class="card-header" id="caixa_senha">
                        <h6 class="mb-0">
                            <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#t_3" 
                                aria-expanded="false" aria-controls="collapseThree">Alterar Password
                            </button>
                        </h6>
                    </div>
                            ...
                            <form action="?a=perfil&p=3" method="post" class="mt-3">
                                <div class="form-group">
                                    <input type="password"
                                        ...
                                        placeholder="Insira aqui a sua password atual"
                                        required>
                                </div>
                                ...
                                <div class="form-group">
                                    <input type="password"
                                        ...
                                        placeholder="Insira aqui a sua nova password" 
                                        required>
                                </div>
