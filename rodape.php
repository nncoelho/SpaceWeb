    <?php
    //=====================================
    // RODAPÉ PRINCIPAL DA APLICAÇÃO WEB 
    //=====================================
    ?>
    </div>
    <div class="container rodape">
        <div class="row">
            ...
            <div class="col-sm-6 col-12 rodape-social text-right">
                <a href="https://www.facebook.com"><i class="fa fa-facebook-square mr-3"></i></a>
                <a href="https://www.twitter.com"><i class="fa fa-twitter-square mr-3"></i></a>
                <a href="https://www.instagram.com"><i class="fa fa-instagram mr-3"></i></a>
            </div>
        </div>
